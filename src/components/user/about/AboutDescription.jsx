  ...
  return (
    <div className="flex justify-center mt-10 px-4">
      <Card className="w-full max-w-5xl">
        <CardBody className="flex flex-col lg:flex-row items-start lg:items-center justify-between gap-6 p-6 border border-gray-300 rounded-lg">
          <div className="lg:w-1/3">
            <Typography variant="small" className="uppercase font-medium text-gray-600 mb-2">
              Know About Us
            </Typography>
