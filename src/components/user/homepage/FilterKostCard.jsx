  ...
  return (
    <section className="w-full">
      <div className="w-[80%] mx-auto mb-10 ml-0 p-3 lg:ml-[140px] flex flex-col justify-center gap-5 ">
        <AnimatedText>
          <h2 className="text-3xl lg:text-4xl font-volkhovBold dark:text-white sm:mt-[30px] mt-[70px]">
            Kost Murah di wilayah Denpasar Selatan
          </h2>
          <p className="text-gray-600 max-w-xl text-[12px] sm:text-[14px] font-mulishSemiBold dark:text-gray-300">
